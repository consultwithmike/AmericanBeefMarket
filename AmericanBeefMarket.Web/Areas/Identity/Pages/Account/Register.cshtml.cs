...
namespace AmericanBeefMarket.Web.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
					...
					{
                        await roleManager.CreateAsync(new IdentityRole { Name = Input.Role });
					}

                    await _userManager.AddToRoleAsync(user, Input.Role);
                    _logger.LogInformation($"User added to role '{Input.Role}'.");
