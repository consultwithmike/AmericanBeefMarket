        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<string>(type: "nvarchar(36)", maxLength: 36, nullable: true),
                    BillingName = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    BillingAddress = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    BillingPhone = table.Column<string>(type: "nvarchar(16)", maxLength: 16, nullable: true),
                    BillingEmail = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    ShippingName = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    ShippingAddress = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    ShippingPhone = table.Column<string>(type: "nvarchar(16)", maxLength: 16, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_ShippingEmail",
                table: "Orders",
                column: "ShippingEmail");

            migrationBuilder.CreateIndex(
                name: "IX_Orders_ShippingPhone",
                table: "Orders",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Ranches_Email",
                table: "Ranches",
                column: "Email");

            migrationBuilder.CreateIndex(
                name: "IX_Ranches_Phone",
                table: "Ranches",
                column: "Phone");
        }
